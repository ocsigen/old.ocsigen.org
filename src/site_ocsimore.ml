...
let _ =
  Wiki_syntax.add_extension Wiki_syntax.wikicreole_parser "wikifile" do_wikifile
...
let _ =
  Wiki_syntax.add_extension Wiki_syntax.wikicreole_parser "script" do_script
...
let _ =
  Wiki_syntax.add_extension Wiki_syntax.wikicreole_parser "atom" do_atom
